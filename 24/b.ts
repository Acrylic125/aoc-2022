...
function traverse(start: Vec2D, end: Vec2D) {
  let minute = 0;
...
let start: Vec2D = [1, 0];
let end: Vec2D = [lines[lines.length - 1].length - 2, lines.length - 1];

const firstTrip = traverse(start, end);
console.log("First trip", firstTrip);
const backTrip = traverse(end, start);
console.log("Back trip", backTrip);
const lastTrip = traverse(start, end);
console.log("Last trip", lastTrip);

console.log("Total", firstTrip + backTrip + lastTrip);
